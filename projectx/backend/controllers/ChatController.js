...
const fetchChats = asyncHandler(async(req,res)=>{
    try{
        Chat.find({users:{$eleMatch:{$eq:req.user._id}}}).then(result=>res.send(result))
...
module.exports= {acceschat,addtoGroup,fetchChats,createGroupChat,renameGroup,removeFromGroup}